# Tell AWS to trust GitHub Actions as an identity provider
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = [
              "repo:${var.github_username}/${var.github_repo}:pull_request",
...
# Give the role permissions to run Terraform
